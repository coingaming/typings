...
declare module MongoDB {
	...
	export interface BulkResult {
		...
		nModified: number;
		nRemoved: number;
		getUpsertedIds(): string[];
		getUpsertedIdAt(index: number): {index: number; _id: string};
	}
	...
	export interface BulkOperation {
		 ...
		 * @param doc
		 */
		removeOne(doc: any): BulkOperation;
		 ...
		 * @param selector
		 */
		find(selector: any): BulkOperation;
		 ...
		 * @param options
		 */
		execute(options?: BulkExecuteOptions, callback?: (err, result) => void): void;
	}
	...
	export interface Collection {
		...
		/**
		 * useLegacyOps is one of the options..
		 *
		 * @param options
		 */
		initializeUnorderedBulkOp(options?: any): BulkOperation;
		initializeOrderedBulkOp(options?: any): BulkOperation;
